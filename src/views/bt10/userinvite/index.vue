  ...
  <div class="app-container">
    <el-card shadow="never" body-class="search-card">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
        <el-form-item label="被邀请人用户" prop="userId">
          <UserSelect
            v-model="queryParams.userId"
            placeholder="请选择被邀请人用户(sys_user.user_id)"
            clearable
            @keyup.enter="handleQuery"
          />
        </el-form-item>
        <el-form-item label="邀请人用户" prop="inviterId">
          <UserSelect
        ...
        <el-form-item label="邀请奖励积分" prop="rewardPoints">
          <el-input-number v-model="queryParams.rewardPoints" :min="0" controls-position="right" style="width: 180px" />
        </el-form-item>
        <el-form-item label="邀请奖励贡献点" prop="rewardContrib">
          <el-input-number v-model="queryParams.rewardContrib" :min="0" controls-position="right" style="width: 180px" />
        </el-form-item>
        <el-form-item>
    ...
    <el-card shadow="never" class="mt10">
      ...
      <el-table-column label="被邀请人用户" align="center" prop="userId" />
      ...
      <el-table-column label="转化状态" align="center" prop="rewardStatus" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="userinviteRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="被邀请人用户" prop="userId">
          <UserSelect v-model="form.userId" placeholder="请选择被邀请人用户(sys_user.user_id)" />
        </el-form-item>
        <el-form-item label="邀请人用户" prop="inviterId">
        ...
        <el-form-item label="邀请奖励积分" prop="rewardPoints">
          <el-input-number v-model="form.rewardPoints" :min="0" controls-position="right" style="width: 100%" />
        </el-form-item>
        <el-form-item label="邀请奖励贡献点" prop="rewardContrib">
          <el-input-number v-model="form.rewardContrib" :min="0" controls-position="right" style="width: 100%" />
        </el-form-item>
