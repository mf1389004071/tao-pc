<template>
  <div class="app-container">
      ...
      <el-row :gutter="10" class="mb8">
        ...
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['bt10:notices:remove']"
          >删除</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            icon="Download"
            @click="handleExport"
            v-hasPermi="['bt10:notices:export']"
          >导出</el-button>
        </el-col>
      ...
      <el-table-column label="状态" align="center" prop="status" />
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            ...
            <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['bt10:notices:remove']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="noticesRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="标题" prop="title">
...
function submitForm() {
  proxy.$refs["noticesRef"].validate(valid => {
    if (valid) {
      form.value.isUrgent = form.value.isUrgent.join(",");
      if (form.value.id != null) {
        ...
        addNotices(form.value).then(response => {
...
function handleExport() {
  proxy.download('bt10/notices/export', {
    ...queryParams.value
