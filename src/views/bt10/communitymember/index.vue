  ...
  <div class="app-container">
    <el-card shadow="never" body-class="search-card">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
        ...
        <el-form-item label="离开时间" prop="leftTime">
          <el-date-picker clearable
            v-model="queryParams.leftTime"
            type="date"
            value-format="YYYY-MM-DD"
            placeholder="请选择离开时间">
          </el-date-picker>
    ...
    <el-card shadow="never" class="mt10">
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            icon="Plus"
            @click="handleAdd"
            v-hasPermi="['bt10:communitymember:add']"
          >新增</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['bt10:communitymember:edit']"
          >修改</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['bt10:communitymember:remove']"
          >删除</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            icon="Download"
            @click="handleExport"
            v-hasPermi="['bt10:communitymember:export']"
          >导出</el-button>
        </el-col>
        <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
      </el-row>

      <el-table v-loading="loading" :data="communitymemberList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="业务状态" align="center" prop="bizStatus" />
        ...
        <el-table-column label="离开时间" align="center" prop="leftTime" width="180">
          <template #default="scope">
      ...
      <el-table-column label="状态" align="center" prop="status">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            ...
            <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['bt10:communitymember:remove']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
/** 提交按钮 */
function submitForm() {
  proxy.$refs["communitymemberRef"].validate(valid => {
    if (valid) {
      if (form.value.id != null) {
        updateCommunitymember(form.value).then(response => {
          proxy.$modal.msgSuccess("修改成功");
          open.value = false;
          getList();
        });
      } else {
        addCommunitymember(form.value).then(response => {
...
function handleExport() {
  proxy.download('bt10/communitymember/export', {
    ...queryParams.value
